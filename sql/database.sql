...
CREATE TABLE IF NOT EXISTS `TIPOCONSUMIDOR` (
	`ID` int AUTO_INCREMENT NOT NULL UNIQUE,
	`NMCONSUMIDOR` varchar(50) NOT NULL,
	`DSCONSUMIDOR` varchar(50),
	`DTINCLUSAO` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
	`DTULTATU` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
	PRIMARY KEY (`ID`)
);
...
CREATE TABLE IF NOT EXISTS `TIPOREFEICAO` (
	`ID` int AUTO_INCREMENT NOT NULL UNIQUE,
	`NMREFEICAO` varchar(50) NOT NULL,
	`DTINCLUSAO` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
	`DTULTATU` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
	PRIMARY KEY (`ID`)
);
...
CREATE TABLE IF NOT EXISTS `REGISTROALIMENTAR` (
	...
	`IDTIPOCONSUMIDOR` int NOT NULL,
	`COMENSAIS` int DEFAULT 0,
	`DSALTERACAOCARD` varchar(100),
	`REPETICAO` int DEFAULT 0,
